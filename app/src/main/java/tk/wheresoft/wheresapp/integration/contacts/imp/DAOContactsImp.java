package tk.wheresoft.wheresapp.integration.contacts.imp;
...
public class DAOContactsImp implements DAOContacts {
    ...
    public boolean create(Contact contact) {
        ...
        builder.withValue(ContactsContract.RawContacts.SYNC2, 0); //Marca si es favorito
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.tk.wheresoft.wheresapp.profile");
