package tk.wheresoft.wheresapp.serverapi;
...
import tk.wheresoft.wheresapp.server.callApi.CallApi;
import tk.wheresoft.wheresapp.server.callApi.model.CallServer;
import tk.wheresoft.wheresapp.server.callApi.model.MessageServer;
import tk.wheresoft.wheresapp.server.registrationApi.RegistrationApi;
import tk.wheresoft.wheresapp.server.registrationApi.model.UserRegistrationServer;
import tk.wheresoft.wheresapp.server.userApi.UserApi;
import tk.wheresoft.wheresapp.server.userApi.model.ContactListServer;
import tk.wheresoft.wheresapp.server.userApi.model.ContactServer;
